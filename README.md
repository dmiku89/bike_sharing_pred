...
### Files
* bike_sharing_eda.ipynb - bike sharing dataset EDA;
* sharing_modelling.ipynb - models and data transformers for model pipelines.
* data - folder with train and submission *.csv datasets.
